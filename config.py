...
#
DEFAULT_FROM_TIME          = os.getenv('DEFAULT_FROM_TIME', '-3h')
...
#
DASHBOARD_APPNAME          = os.getenv('DASHBOARD_APPNAME', 'Tessera')

#
# A data base URL for dashboard storage. See
# http://docs.sqlalchemy.org/en/rel_0_9/core/engines.html
#
SQLALCHEMY_DATABASE_URI    = os.getenv('SQLALCHEMY_DATABASE_URI', 'sqlite:///tessera.db')
...
#
GRAPHITE_AUTH              = os.getenv('GRAPHITE_AUTH', '')
...
#
CONNECTED_LINES            = os.getenv('CONNECTED_LINES', 0)
...
#
CHART_RENDERER             = os.getenv('CHART_RENDERER', 'flot')
...
#
DOWNSAMPLE_TIMESERIES      = os.getenv('DOWNSAMPLE_TIMESERIES', 1)

#
# Default time zone to display time stamps in. This is overridable by
# user sessions.
#
DISPLAY_TIMEZONE           = os.getenv('DISPLAY_TIMEZONE', 'Etc/UTC')
...
#
DEFAULT_PROPSHEET_AUTOCLOSE_SECONDS = os.getenv('DEFAULT_PROPSHEET_AUTOCLOSE_SECONDS', 3)
...
#
DEFAULT_REFRESH_INTERVAL = os.getenv('DEFAULT_REFRESH_INTERVAL', 60)
